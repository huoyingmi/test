...
db.on('open',()=>{
    ...
    */
    /*
    //插入一个
    UserModel.insertMany({name:getName(),age:getRandom(0,110),major:getMajor()},(err,docs)=>{
        if(err){
    ...
    */
    ...
    UserModel.insertMany(
        [
            {name:getName(),age:getRandom(0,110),major:getMajor()},
            {name:getName(),age:getRandom(0,110),major:getMajor()},
            {name:getName(),age:getRandom(0,110),major:getMajor()}
        ],
        (err,docs)=>{
    ...
    */
    /*
    //create没有insertMany效率高，建议使用insertMany方法
    UserModel.create({name:getName(),age:getRandom(0,110),major:getMajor()},(err,docs)=>{
        if(err){
